...
![MNISTSample](https://github.com/HenryJia/diffusion-classroom/blob/main/nonequilibrium-thermodynamics/samples/epoch_1999.png?raw=true "MNIST Sample after 2000 epochs")
...
Training this thing is somewhat of a pain in the arse. The complexity kind of makes it hard to debug, and it seems to be somewhat slow to train. Normally models on MNIST can train in a few epochs, but this seems to take longer.
