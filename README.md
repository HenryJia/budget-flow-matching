...
3. We use efficient training strategies. By the looks of it, the REPA paper [ArXiv](https://arxiv.org/abs/2410.06940) has a very efficient optimisation strategy. So we'll use that one. Sticking with point 1, to compute the REPA embeddings, we use DinoV2-small. This is a capable and very small model, but is still more than sufficiently capable for what we need.
